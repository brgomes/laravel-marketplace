...
@section('content')
    <div class="row front">
        <div class="col-4">
            ...
            @else
                <img src="{{ asset('storage/sem-logo.png') }}" alt="Logo da loja {{ $store->name }}" class="img-fluid">
            @endif
        </div>
        <div class="col-8">
            <h2>{{ $store->name }}</h2>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('product.single', $product->slug) }}" class="btn btn-success">Ver produto</a>
                    </div>
                </div>
            </div>
